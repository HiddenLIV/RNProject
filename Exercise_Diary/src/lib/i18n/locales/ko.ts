...
const ko: Translations = {
  ...
  home: {
    ...
    weeklySummary: {
      title: '활동 기록',
      activeDays: (days) => `이번 주 ${days}일 운동`,
      prCount: (count) => (count > 0 ? `PR ${count}회 경신` : 'PR 갱신 없음'),
      empty: '아직 기록이 없어요. 첫 운동을 시작해보세요.',
      openAccessibility: '활동 기록 보기',
    },
    streakBadge: (days) => `${days}일`,
  },
  activity: {
    title: '활동 기록',
    previousMonth: '이전 달',
  ...
  reps: {
    currentSetLabel: '이번 세트',
    recordedSetsLabel: '기록',
    addSetButton: '세트 추가',
    saveButton: '기록 저장',
    savedNotice: '저장되었습니다',
    errorMinReps: '1회 이상 입력해 주세요',
  ...
  help: {
    ...
    sections: [
      ...
      },
      {
        title: '이번 주 활동 확인',
        description:
          '홈 화면 상단의 "활동 기록" 카드에서 이번 주 운동한 날수와 새로 세운 기록(PR) 횟수를 볼 수 있어요. 카드를 누르면 월별 캘린더로 이동해 날짜별 기록을 확인할 수 있고, 운동 카드의 "🔥" 배지로 연속 기록일수(스트릭)도 확인할 수 있어요.',
      },
      {
        title: '운동 촬영',
        description:
  ...
  settings: {
    ...
    modeLight: '라이트',
    modeDark: '다크',
    soundHapticsSectionLabel: '소리 및 진동',
    reminderSectionLabel: '리마인더 알림',
    hapticsLabel: '진동',
  ...
  backup: {
    ...
    importErrorMessage: '이 파일로 복원하지 못했어요. 다시 시도해 주세요.',
    errorInvalidFile: '유효한 HiddenReps 백업 파일이 아니에요.',
    errorUnsupportedVersion: '더 최신 버전의 앱에서 만든 백업이라 이 앱에서는 열 수 없어요.',
    errorShareUnavailable: '이 기기에서는 공유 기능을 쓸 수 없어요.',
    errorReadFailed: '파일을 읽지 못했어요. 다시 시도해 주세요.',
  },
  records: {
    title: '기록',
    empty: '아직 기록이 없습니다.\n측정으로 첫 기록을 남겨보세요.',
