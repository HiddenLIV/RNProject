  ...
  help: {
    ...
    sections: [
      ...
      },
      {
        title: '이번 주 활동 확인',
        description:
          '홈 화면 상단의 "활동 기록" 카드에서 이번 주 운동한 날수와 새로 세운 기록(PR) 횟수를 볼 수 있어요. 카드를 누르면 월별 캘린더로 이동해 날짜별 기록을 확인할 수 있고, 이번 주 2회 이상 한 운동은 카드의 "🔥" 배지로 표시돼요.',
      },
      {
        title: '운동 촬영',
        description:
