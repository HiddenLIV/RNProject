...
const ja: Translations = {
  ...
  home: {
    ...
    weeklySummary: {
      title: '活動記録',
      activeDays: (days) => `今週${days}日運動`,
      prCount: (count) => (count > 0 ? `PR${count}回更新` : 'PR更新なし'),
      empty: 'まだ記録がありません。最初の運動を始めてみましょう。',
      openAccessibility: '活動記録を見る',
    },
    streakBadge: (count) => `週${count}回`,
  },
  activity: {
    title: '活動記録',
    previousMonth: '前の月',
  ...
  reps: {
    currentSetLabel: '今回のセット',
    recordedSetsLabel: '記録',
    addSetButton: 'セットを追加',
    saveButton: '記録を保存',
    savedNotice: '保存しました',
    errorMinReps: '1回以上入力してください',
  ...
  help: {
    ...
    sections: [
      ...
      },
      {
        title: '今週の活動を確認する',
        description:
          'ホーム画面上部の「活動記録」カードで、今週の運動日数と新しく更新したPR(自己ベスト)の回数を確認できます。カードをタップすると月間カレンダーが開いて日付ごとの記録を確認でき、今週2回以上行った運動はカードに「🔥」バッジが表示されます。',
      },
      {
        title: '運動を撮影する',
        description:
  ...
  backup: {
    ...
    cancel: 'キャンセル',
    exportLabel: 'エクスポート',
    exportDescription: 'すべての運動と記録をファイルに保存して、保管したり送ったりできます。',
    exportSuccessToast: 'バックアップファイルを作成しました',
    exportErrorTitle: 'エクスポートに失敗しました',
    exportErrorMessage: 'バックアップファイルを作成できませんでした。もう一度お試しください。',
    importLabel: 'インポート',
    importDescription: 'バックアップファイルからデータを復元します。',
    importConfirmTitle: 'すべてのデータを置き換えますか?',
    importConfirmMessage: 'この端末のすべての運動と記録がバックアップファイルの内容に置き換わります。元に戻せません。',
    importConfirmButton: '置き換える',
    importSuccessToast: 'データを復元しました',
    importErrorTitle: 'インポートに失敗しました',
    importErrorMessage: 'このファイルから復元できませんでした。もう一度お試しください。',
    errorInvalidFile: '有効なHiddenRepsのバックアップファイルではありません。',
    errorUnsupportedVersion: 'より新しいバージョンのアプリで作成されたバックアップのため、このアプリでは読み込めません。',
    errorShareUnavailable: 'この端末では共有機能を利用できません。',
    errorReadFailed: 'ファイルを読み込めませんでした。もう一度お試しください。',
  },
  records: {
    title: '記録',
    empty: 'まだ記録がありません。\n測定して最初の記録を残しましょう。',
