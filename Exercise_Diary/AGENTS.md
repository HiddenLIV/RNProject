...
- RepsScreen의 세트 간 휴식 종료 벨은 2026-08-25부터 스크립트 생성음이 아니라 외부에서 받은 실제 녹음(`assets/sounds/opening-bell.mp3`)을 직접 쓴다. 외부 라이선스 에셋이면 출처·라이선스를 `docs/THIRD_PARTY_ASSETS.md`에 기록할 것.
- 커밋 메시지는 한국어로 작성한다
